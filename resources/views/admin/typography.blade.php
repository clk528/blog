    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p>This is an example of standard paragraph text. This is an example of <a href="typography.blade.php#">link
                        anchor text</a> within body copy.</p>
                <p>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><abbr title="HyperText Markup Language" class="initialism">HTML</abbr> is an abbreviation for a
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <h1>Code</h1>
                <p>This is an example of an inline code element within body copy. Wrap inline code within a <code>&lt;code&gt;...&lt;/code&gt;</code>
                    tag.</p>
